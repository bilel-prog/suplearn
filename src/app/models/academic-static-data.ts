import { Year, Module, Subject } from './academic.model';

export type StaticModule = Module & { subjects?: Subject[] };
export type StaticYear = Year & { modules?: StaticModule[] };

export const STATIC_ACADEMIC_DATA: StaticYear[] = [
  {
    id: 1,
